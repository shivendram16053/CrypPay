    ...
    return (
        <nav className="flex flex-1 items-center justify-center">
            <ul className="flex flex-col space-y-10">
                ...
                <li>
                    <WalletMultiButton className='phantom-button' startIcon={<UserCircleIcon style={{height:24,width:24,color:'lime'}}/>}>
                      <span className='text-sm font-semibold text-[lime]'> {connected ? truncate(publicKey.toString(),10):"Connect Wallet"}</span>
                    </WalletMultiButton>
